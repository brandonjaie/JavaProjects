 ...
 * @author Brandon
 */
@WebServlet(name = "tip-calculator", urlPatterns = {"/tip-calculator"})
public class TipCalculatorServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher rd = request.getRequestDispatcher("tipcalculator.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            double tip = bill * tipPct;
            double total = bill + tip;

            request.setAttribute("bill", nf.format(bill));
