...
function drawChart2() {
    $.get('stats/chart').success(function (data) {
        ...
        // object
        var dataTable = new google.visualization.DataTable(data); // set options for the chart - we're setting the main title, 
        //the verticle and horizontal axis labels and the height/width of the chart
                var options = {
                    title: 'Contacts By Company',
                    vAxis: {title: 'Company', titleTextStyle: {color: 'red'}},
                    hAxis: {title: 'Num Contacts', titleTextStyle: {color: 'red'}}, 
                   ...
                   // you want to render the chart - here it is the <div> called 'chartDiv'on the jQueryChart.jsp page
                var chart = new google.visualization.BarChart(document.getElementById('chart_div'));
