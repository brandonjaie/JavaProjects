...
<html>
    ...
    <body>
        ...
        <div class="container-fluid" style="margin: 0px 10px;">
            ...
            <hr/>
            <sf:form class="form-horizontal" modelAttribute="dvd" role="form" action="editDVDNoAjax" method="POST">
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                        <sf:input type="text" class="form-control" id="edit-mpaa-rating" path="mpaaRating" placeholder="MPAA Rating"/>
                    ...
                    <div class="form-group">
                        ...
                        <sf:errors path="director" cssClass="textt-danger"></sf:errors>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                        <sf:select id="edit-genre" path="genre.genreId" class="form-control"> 
